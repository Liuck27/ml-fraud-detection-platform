...
easy number that attracts a recruiter's eye; PR-AUC is the number the
project uses to compare models honestly (`retrain_dag.py:112` compares
candidates on PR-AUC, not AUC-ROC).
